...
```
   1103 scenes        10 seasons, 2017 to 2026, Sentinel-2 L1C
     35 scripts       one question each, all committed with their artefacts
...
scripts/                # THE ANALYSIS: 35 scripts, one question each; the 22 with a published answer are tabled above
