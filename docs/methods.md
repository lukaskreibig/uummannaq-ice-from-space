...
which is **267.3 km²** on the WGS84 ellipsoid, about 14.7 by 18.1 km. Of that, **253.1 km² is water** and 14.2 km² is land, measured from `assets/landmask.tif` rather than assumed: the grid is 1474 by 1812 cells at 10 m and 0.05313 of them are land. The water figure is the one the story multiplies its anomalies by, and it is the only area number that should appear anywhere.
...
series reported anomalies of up to 1367 km² over a water area of 253.1 km², which is
